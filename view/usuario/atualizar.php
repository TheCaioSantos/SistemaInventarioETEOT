	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<form class="form-material row" action="controller/usuario.php<?php echo isset($_GET['id-usuario']) ? '?id-usuario=' . $_GET['id-usuario'] : ''; ?>" method="POST">
					...
					<div class="form-group col-md-4 m-t-20">
						<select name="nivel-usuario" class="form-control">
							...
							<?php foreach ($nivel_usuario as $posicao => $valor): ?>
